...
/**
 * Abstract base class for Autowasp tables to reduce code duplication.
 */
public abstract class AbstractAutowaspTable extends JTable {

    private static final long serialVersionUID = 1L;
    protected final transient Autowasp extender;

    protected AbstractAutowaspTable(TableModel tableModel, Autowasp extender) {
        super(tableModel);
