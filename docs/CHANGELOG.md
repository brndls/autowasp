...
### Security & CI
- **CI/CD**: Enforced SonarQube Quality Gate in GitHub Actions. CI will now fail if quality standards are not met.

## [2.2.8] - 2026-01-06

### Fixed
- **Code Quality**: Resolved all IDE linting warnings in test suite (Argument order, Lambda refactoring).
- **Maintenance**: Version bump for release consistency.
